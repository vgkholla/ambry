...
public class MessageFormatRecord {
  ...
  private static final short Ttl_Update_Version_V1 = 1;
  ...
  public static class Update_Format_V3 {
    ...
    public static int getRecordSize(UpdateRecord.Type type) {
      ...
      switch (type) {
        case DELETE:
          ...
          break;
        case TTL_UPDATE:
          subRecordSize = Ttl_Update_Format_V1.getRecordSize();
          break;
        default:
    ...
    public static void serialize(ByteBuffer outputBuffer, UpdateRecord updateRecord) {
      ...
      switch (updateRecord.getType()) {
        case DELETE:
          ...
          break;
        case TTL_UPDATE:
          Ttl_Update_Format_V1.serialize(outputBuffer, updateRecord.getTtlUpdateSubRecord());
          break;
        default:
    ...
    private static TtlUpdateSubRecord getTtlUpdateSubRecord(DataInputStream inputStream)
      ...
      short version = inputStream.readShort();
      switch (version) {
        case Ttl_Update_Version_V1:
          return Ttl_Update_Format_V1.deserialize(inputStream);
        default:
   ...
   *
   */
  private static class Ttl_Update_Format_V1 {
    ...
    static void serialize(ByteBuffer outputBuffer, TtlUpdateSubRecord ttlUpdateSubRecord) {
      outputBuffer.putShort(Ttl_Update_Version_V1);
